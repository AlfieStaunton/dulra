    ...
    <div className="min-h-screen bg-[#f0f7f2] font-['Nunito'] text-[#0f2318] flex flex-col items-center">
      ...
      <div className="w-full max-w-[390px] min-h-screen flex flex-col relative shadow-xl bg-[#f0f7f2]">
        ...
        <header className="px-6 pt-12 pb-6 flex justify-between items-center">
          <div>
            <p className="font-['DM_Mono'] text-sm text-[#4d7460]">
              {" "}
              Dia Dhuit 👋
            </p>
        ...
        <main className="flex-1 px-6 pb-24 overflow-y-auto">
          ...
          <div className="flex gap-3 mb-8">
            <div className="flex-1 bg-white p-4 rounded-2xl border border-[rgba(26,92,54,0.15)] shadow-sm text-center">
              <p className="font-['DM_Mono'] text-2xl font-medium text-[#1a5c35]">
                12
              </p>
              <p className="text-xs font-semibold text-[#4d7460] uppercase tracking-wider mt-1">
                Sightings
              </p>
            </div>
            <div className="flex-1 bg-white p-4 rounded-2xl border border-[rgba(26,92,54,0.15)] shadow-sm text-center">
          ...
          >
            ...
            <div className="flex justify-between items-center">
              <h2 className="font-['Lora'] text-3xl text-white font-semibold">
                {" "}
                Log a Sighting
              </h2>
          ...
          <div>
            <div className="flex justify-between items-end mb-4">
              <h3 className="font-['Lora'] text-xl text-[#2a5c35] font-semibold">
                {" "}
                Recent Sightings
              </h3>
              <button className="text-[#1a6b8c] text-sm font-semibold hover:underline">
                {" "}
                View all
              </button>
            </div>
            ...
            <div className="flex flex-col gap-3">
              {loading ? (
                <p className="text-center text-[#4d7460] py-4">
                  Loading sightings...
                </p>
              ) : sightings.length === 0 ? (
                <p className="text-center text-[#4d7460] py-4 bg-white rounded-2xl border border-[rgba(26,92,53,0.15)]">
                ...
                sightings.map((sighting) => (
                  <button
                    key={sighting.id}
                    className="bg-white p-4 rounded-2xl border border-[rgba(26,92,53,0.15)] shadow-sm flex items-center justify-between hover:bg-[#fafdfa] transition-colors"
                  >
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="font-['DM_Mono'] bg-[#f0f7f2] text-[#1a5c35] px-3 py-1 rounded-lg text-sm -font-medium">
                        x{sighting.count}
                      </span>
