...
function Auth() {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            setMessage(error.response?.data?.error || 'An error occurred. PPlease try again.');
        }
    };

    //temp layout
    return (
        <div style={{ padding: '20px', fontFamily: 'sans-serif', maxWidth: '400px', margin: '40px auto', textAlign: 'center'}}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap:'15px'}}>
                ...
                <button type="submit" style={{ padding: '12px', fontSize: '16px', backgroundColor: '#2e7d32', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer'}}>
            ...
            <p style={{ marginTop: '20px'}}>
                ...
                <span onClick={() => setIsLogin(!isLogin)} style={{ color: '#2e7d32', cursor: 'pointer', textDecoration: 'underline', fontWeight: 'bold'}}>
